...
The workflow uses the Amplitude Dispersion Index (ADI) for initial classification and provides a suite of tools for generating interferograms, filtering phase time series, and interactively visualizing the results.
